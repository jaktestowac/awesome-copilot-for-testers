...
| `flake-control`            | retry config plus a quarantine register or dashboard    | rate tracked against a threshold | `retries: 3` with no measurement - that is flake _hiding_           |
