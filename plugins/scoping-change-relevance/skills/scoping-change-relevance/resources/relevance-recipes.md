...
The rule worth stating: **a new tool grant is always in scope for injection testing.** Expanding what the model can *do* expands what an injection can achieve, even when no prompt text changed.
