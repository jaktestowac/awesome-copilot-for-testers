...
Use the replacement custom agent instead: [`tech-debt-auditor`](../agents/tech-debt-auditor.agent.md)

Note: this chat mode's persona was a test-automation **code reviewer**, which now lives in [`test-code-reviewer`](../agents/test-code-reviewer.agent.md). For repository-wide debt audits, use [`tech-debt-auditor`](../agents/tech-debt-auditor.agent.md).
